...
int main() {
  ...
  char outfilename[128] = "road2.jpg";    /* Name of the output "edge" image */
  char composedfname[128] = "road2.jpg";  /* Name of the output "direction" image */
